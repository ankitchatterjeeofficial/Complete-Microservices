...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponseMessage> handleNoResourceFoundException(NoResourceFoundException ex)
    {
        ...
        ApiResponseMessage response = ApiResponseMessage.builder().message( ex.getMessage()+" Enter Correct Path variable").status(HttpStatus.BAD_REQUEST).success(false).build();
        return new ResponseEntity<>(response,HttpStatus.BAD_REQUEST);
